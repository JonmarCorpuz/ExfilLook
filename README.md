...
**Exfiltrate through Outlook** is a customizable payload designed for red team operations and enables remote command execution on a compromised Windows system, captures the output into a text file, and exfiltrates the file via Outlook Mail to a designated temporary email address.
